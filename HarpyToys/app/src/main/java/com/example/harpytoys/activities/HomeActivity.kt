...
import com.example.harpytoys.adapter.ProductAdapter
...
class HomeActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupHeader()
        setupRecyclerView()
        loadProducts()           // Agora carrega do banco
    }
    ...
    private fun setupHeader() {
        ...
        findViewById<ImageButton>(R.id.btnFavorites).setOnClickListener {
            Toast.makeText(this, "Tela de Favoritos em breve", Toast.LENGTH_SHORT).show()
        }
                ...
                withContext(Dispatchers.Main) {
                    if (response.isSuccessful) {
                        response.body()?.let {
                            ...
                            Toast.makeText(this@HomeActivity, "Nenhum produto encontrado", Toast.LENGTH_SHORT).show()
                        }
                    } else {
            ...
            try {
                ...
                withContext(Dispatchers.Main) {
                    if (response.isSuccessful) {
                        ...
                        Toast.makeText(this@HomeActivity, "Falha ao adicionar ao carrinho", Toast.LENGTH_SHORT).show()
                    }
                }
            } catch (e: Exception) {
                withContext(Dispatchers.Main) {
